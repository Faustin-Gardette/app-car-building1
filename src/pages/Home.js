    ...
    <div>
      ...
      <div className="vehicules-container">
        <div className="vehicles-text">
          <h4>Modèles de voiture</h4>
          <h2>Nos voitures de locoation</h2>
          <p>
            Choisissez parmi une variété de nos incroyables véhicules à louer
            pour votre prochaine aventure ou votre prochain voyage d'affaires
          </p>
        </div>
        <div className="vehicule-component">
          <Vehiclemodels />
        </div>
      </div>
